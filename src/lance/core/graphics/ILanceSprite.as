package lance.core.graphics 
{
	...
	import lance.core.graphics.ISprite;
	/**
	 * @author SSen
	 */
	public interface ILanceSprite extends ISprite 
	{
		...
		function get containerMode() : Boolean
		function set containerMode(containerMode : Boolean) : void
	}
}
