package lance.core.events
{
	 ...
	 * @author SSen
	 */
	public class LanceEvent extends Event 
	{
		/** 활성 될때 */
		...
		public function LanceEvent(type : String, bubbles : Boolean = false, cancelable : Boolean = false)
		{
