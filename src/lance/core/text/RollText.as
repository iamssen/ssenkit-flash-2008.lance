package lance.core.text 
{
	 ...
	 * @author SSen
	 */
	public class RollText extends LanceSprite implements ITextObject
	{
		private var _width : int;
		private var _height : int;
		private var _text : String;
		private var _defaultFormat : TextFormat;
		private var _rollFormat : TextFormat;
		...
		private var _txt1 : LanceTextField;
		private var _txt2 : LanceTextField;
		 ...
		 * @param width 가로 길이
		 * @param height 세로 길이
		 * @param defaultFormat 기본 TextFormat (TextStyle 지원)
		 * @param rollFormat 롤링시의 TextFormat (TextStyle 지원)
		 ...
		 */
		public function RollText(text : String, width : int, height : int, defaultFormat : TextFormat, rollFormat : TextFormat = null, verticalAlign : String = "middle",modeOverRoll : Boolean = false, bgColor : Boolean = false, defaultBGColor : uint = 0xffffff, rollBGColor : uint = 0xffffff, speed : int = 20, replaceText : String = "...", replaceWidth : int = 15)
		{
			super();
			...
			_rollFormat = (rollFormat != null) ? rollFormat : defaultFormat;
			_bgColor = bgColor;
			...
			_txt1 = new LanceTextField();
			_txt1.text = _text;
			_txt1.setTextFormat(_defaultFormat);
		...
		private function verticalAlign(txt : LanceTextField) : void
		{
			var y : int;
		...
		private function mode2() : void
		{
			...
			_txt1.text = _text;
			_txt1.setTextFormat(_rollFormat);
			...
			_txt2 = new LanceTextField();
			_txt2.defaultTextFormat = _rollFormat;
			_txt2.text = _text;
			_txt2.setTextFormat(_rollFormat);
